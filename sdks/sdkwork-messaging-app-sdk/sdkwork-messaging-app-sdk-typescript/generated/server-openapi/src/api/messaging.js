...
export class MessagingVerificationCodesApi {
    ...
    async create(body, params) {
        ...
        return this.client.post(appApiPath(`/messaging/verification_codes`), body, undefined, requestHeaders, 'application/json');
    }
    /** messaging.verificationCodes.verify */
    async verify(body, params) {
        const requestHeaders = buildRequestHeaders({
            'Idempotency-Key': { value: params.idempotencyKey, style: 'simple', explode: false },
        }, {});
        return this.client.post(appApiPath(`/messaging/verification_codes/verify`), body, undefined, requestHeaders, 'application/json');
    }
}
export class MessagingPushDevicesApi {
    ...
    async register(body, params) {
        ...
        return this.client.post(appApiPath(`/messaging/push_devices`), body, undefined, requestHeaders, 'application/json');
    }
    /** messaging.pushDevices.unregister */
    async unregister(deviceId, params) {
        const requestHeaders = buildRequestHeaders({
            'Idempotency-Key': { value: params.idempotencyKey, style: 'simple', explode: false },
        }, {});
        return this.client.delete(appApiPath(`/messaging/push_devices/${serializePathParameter(deviceId, { name: 'deviceId', style: 'simple', explode: false })}`), undefined, requestHeaders);
    }
}
export class MessagingAnnouncementsApi {
    ...
    async list(params) {
        ...
        return this.client.get(appendQueryString(appApiPath(`/messaging/announcements`), query));
    }
    /** messaging.announcements.acknowledge */
    async acknowledge(announcementId, params) {
        const requestHeaders = buildRequestHeaders({
            'Idempotency-Key': { value: params.idempotencyKey, style: 'simple', explode: false },
        }, {});
        return this.client.post(appApiPath(`/messaging/announcements/${serializePathParameter(announcementId, { name: 'announcementId', style: 'simple', explode: false })}/acknowledge`), undefined, undefined, requestHeaders);
    }
}
export class MessagingNotificationsApi {
    ...
    async list(params) {
        ...
        return this.client.get(appendQueryString(appApiPath(`/messaging/notifications`), query));
    }
    /** messaging.notifications.markRead */
    async markRead(notificationId, params) {
        const requestHeaders = buildRequestHeaders({
            'Idempotency-Key': { value: params.idempotencyKey, style: 'simple', explode: false },
        }, {});
        return this.client.post(appApiPath(`/messaging/notifications/${serializePathParameter(notificationId, { name: 'notificationId', style: 'simple', explode: false })}/read`), undefined, undefined, requestHeaders);
    }
}
