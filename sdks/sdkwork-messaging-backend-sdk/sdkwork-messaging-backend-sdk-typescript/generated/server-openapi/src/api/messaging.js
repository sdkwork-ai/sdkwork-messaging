...
export class MessagingTemplatesApi {
    ...
    async list(params, requestOptions) {
        ...
        return this.client.request(appendQueryString(backendApiPath(`/messaging/templates`), query), { ...(requestOptions?.signal !== undefined ? { signal: requestOptions.signal } : {}), ...(requestOptions?.timeout !== undefined ? { timeout: requestOptions.timeout } : {}), method: 'GET', sdkworkUnwrapKind: 'page' });
    }
...
export class MessagingChannelsApi {
    ...
    async retrieve(channel, params, requestOptions) {
        ...
        return this.client.request(appendQueryString(backendApiPath(`/messaging/channels/${serializePathParameter(channel, { name: 'channel', style: 'simple', explode: false })}`), query), { ...(requestOptions?.signal !== undefined ? { signal: requestOptions.signal } : {}), ...(requestOptions?.timeout !== undefined ? { timeout: requestOptions.timeout } : {}), method: 'GET', sdkworkUnwrapKind: 'item' });
    }
    ...
    async update(channel, body, params, requestOptions) {
        ...
        return this.client.request(backendApiPath(`/messaging/channels/${serializePathParameter(channel, { name: 'channel', style: 'simple', explode: false })}`), { ...(requestOptions?.signal !== undefined ? { signal: requestOptions.signal } : {}), ...(requestOptions?.timeout !== undefined ? { timeout: requestOptions.timeout } : {}), method: 'PUT', body, contentType: 'application/json', ...(requestHeaders !== undefined ? { headers: requestHeaders } : {}), sdkworkUnwrapKind: 'item' });
    }
}
export class MessagingVerificationPoliciesApi {
    ...
    async list(params, requestOptions) {
        ...
        return this.client.request(appendQueryString(backendApiPath(`/messaging/verification_policies`), query), { ...(requestOptions?.signal !== undefined ? { signal: requestOptions.signal } : {}), ...(requestOptions?.timeout !== undefined ? { timeout: requestOptions.timeout } : {}), method: 'GET', sdkworkUnwrapKind: 'page' });
    }
    ...
    async update(policyId, body, params, requestOptions) {
        ...
        return this.client.request(backendApiPath(`/messaging/verification_policies/${serializePathParameter(policyId, { name: 'policyId', style: 'simple', explode: false })}`), { ...(requestOptions?.signal !== undefined ? { signal: requestOptions.signal } : {}), ...(requestOptions?.timeout !== undefined ? { timeout: requestOptions.timeout } : {}), method: 'PUT', body, contentType: 'application/json', ...(requestHeaders !== undefined ? { headers: requestHeaders } : {}), sdkworkUnwrapKind: 'item' });
    }
}
export class MessagingOutboundMessagesApi {
    ...
    async list(params, requestOptions) {
        ...
        return this.client.request(appendQueryString(backendApiPath(`/messaging/outbound_messages`), query), { ...(requestOptions?.signal !== undefined ? { signal: requestOptions.signal } : {}), ...(requestOptions?.timeout !== undefined ? { timeout: requestOptions.timeout } : {}), method: 'GET', sdkworkUnwrapKind: 'page' });
    }
    ...
    async create(body, params, requestOptions) {
        ...
        return this.client.request(backendApiPath(`/messaging/outbound_messages`), { ...(requestOptions?.signal !== undefined ? { signal: requestOptions.signal } : {}), ...(requestOptions?.timeout !== undefined ? { timeout: requestOptions.timeout } : {}), method: 'POST', body, contentType: 'application/json', ...(requestHeaders !== undefined ? { headers: requestHeaders } : {}), sdkworkUnwrapKind: 'item' });
    }
}
export class MessagingPushMessagesApi {
    ...
    async list(params, requestOptions) {
        ...
        return this.client.request(appendQueryString(backendApiPath(`/messaging/push_messages`), query), { ...(requestOptions?.signal !== undefined ? { signal: requestOptions.signal } : {}), ...(requestOptions?.timeout !== undefined ? { timeout: requestOptions.timeout } : {}), method: 'GET', sdkworkUnwrapKind: 'page' });
    }
    ...
    async create(body, params, requestOptions) {
        ...
        return this.client.request(backendApiPath(`/messaging/push_messages`), { ...(requestOptions?.signal !== undefined ? { signal: requestOptions.signal } : {}), ...(requestOptions?.timeout !== undefined ? { timeout: requestOptions.timeout } : {}), method: 'POST', body, contentType: 'application/json', ...(requestHeaders !== undefined ? { headers: requestHeaders } : {}), sdkworkUnwrapKind: 'item' });
    }
}
export class MessagingAnnouncementsApi {
    ...
    async list(params, requestOptions) {
        ...
        return this.client.request(appendQueryString(backendApiPath(`/messaging/announcements`), query), { ...(requestOptions?.signal !== undefined ? { signal: requestOptions.signal } : {}), ...(requestOptions?.timeout !== undefined ? { timeout: requestOptions.timeout } : {}), method: 'GET', sdkworkUnwrapKind: 'page' });
    }
    ...
    async create(body, params, requestOptions) {
        ...
        return this.client.request(backendApiPath(`/messaging/announcements`), { ...(requestOptions?.signal !== undefined ? { signal: requestOptions.signal } : {}), ...(requestOptions?.timeout !== undefined ? { timeout: requestOptions.timeout } : {}), method: 'POST', body, contentType: 'application/json', ...(requestHeaders !== undefined ? { headers: requestHeaders } : {}), sdkworkUnwrapKind: 'item' });
    }
}
export class MessagingNotificationsApi {
    ...
    async list(params, requestOptions) {
        ...
        return this.client.request(appendQueryString(backendApiPath(`/messaging/notifications`), query), { ...(requestOptions?.signal !== undefined ? { signal: requestOptions.signal } : {}), ...(requestOptions?.timeout !== undefined ? { timeout: requestOptions.timeout } : {}), method: 'GET', sdkworkUnwrapKind: 'page' });
    }
    ...
    async create(body, params, requestOptions) {
        ...
        return this.client.request(backendApiPath(`/messaging/notifications`), { ...(requestOptions?.signal !== undefined ? { signal: requestOptions.signal } : {}), ...(requestOptions?.timeout !== undefined ? { timeout: requestOptions.timeout } : {}), method: 'POST', body, contentType: 'application/json', ...(requestHeaders !== undefined ? { headers: requestHeaders } : {}), sdkworkUnwrapKind: 'item' });
    }
}
