# sdkwork-messaging Source Configuration
...
| Item | Value |
| --- | --- |
| `appId` | `sdkwork-messaging` |
| `runtimeCode` | `messaging` |
| Config root | `/etc/sdkwork/messaging/` |
| Runtime TOML | `/etc/sdkwork/messaging/config.toml` |
| Secrets | `/etc/sdkwork/messaging/secrets/` |
| Override | `SDKWORK_MESSAGING_CONFIG_FILE` |
