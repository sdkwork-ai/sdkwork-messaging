# Runbook — sdkwork-messaging deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-messaging-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-messaging/bundle`, loads the image, starts
