...
Module `sdkwork-messaging` · runtime code `messaging` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `messaging-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `messaging-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `messaging-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `messaging-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `messaging.sdkwork.com` | 443 ssl + 80 |
