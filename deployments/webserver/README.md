...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `messaging-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `messaging-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `messaging-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `messaging.sdkwork.com` | 443 ssl + 80 |
